...
try {
    $albums = db_query(
        'SELECT a.*, 
                IFNULL(a.cover_image, (SELECT file_path FROM album_photos WHERE album_id = a.id ORDER BY display_order DESC, id DESC LIMIT 1)) AS main_image,
    ...
    <div class="container">
        ...
        <div class="album-grid">
            ...
            <?php foreach ($albums as $album): ?>
                <a href="photos.php?album_id=<?= (int) $album['id']; ?>" class="album-card-link">
