...
$pageTitle = 'Aide humanitaire';
$content = 'Actions humanitaires menées au cœur des zones vulnérables pour répondre aux besoins alimentaires urgents des populations les plus démunies.';

// Données structurées : Nos Réalisations (titre, date, lieu, description, image)
$realisations = [
    [
        'annee' => '2021',
        'date' => '02 juillet 2021',
        'titre' => 'Descente à l’orphelinat C.O.C',
        'lieu' => 'Bandal Tshibangu',
        'description' => 'Première mission humanitaire : dons de première nécessité et moments d’échange sur les expériences de vie avec les enfants. Cette rencontre a permis à la Fondation TMK de comprendre les réalités et épreuves des orphelins, renforçant son engagement en faveur des enfants vulnérables.',
        'image' => 'images/orphelinat_coc_2021/img-0.png',
        'images' => [
            ['src' => 'images/orphelinat_coc_2021/img-0.png', 'alt' => 'Groupe devant l\'orphelinat COC'],
            ['src' => 'images/orphelinat_coc_2021/img-1.png', 'alt' => 'Enfants en classe avec un enseignant'],
            ['src' => 'images/orphelinat_coc_2021/img-2.png', 'alt' => 'Groupe de personnes faisant la queue à l\'intérieur'],
            ['src' => 'images/orphelinat_coc_2021/img-3.png', 'alt' => 'Distribution de sacs de riz']
        ]
    ],
    [
        'annee' => '2022',
        'date' => '02 octobre 2022',
        'titre' => 'Descente au centre d’accueil de l’État',
        'lieu' => 'Bandalungwa, avenue Ango-Ango',
        'description' => 'Espace de protection et d’espoir pour enfants privés de milieu familial. La Fondation a mené une réflexion approfondie sur ses méthodes d’intervention sociale, en mettant l’accent sur des actions centrées sur la dignité, la protection et l’éducation.',
        'image' => 'images/centre_accueil_etat_2022/photo-groupe.png',
        'images' => [
            ['src' => 'images/centre_accueil_etat_2022/photo-groupe.png', 'alt' => 'Groupe d\'adultes et d\'enfants au centre d\'accueil de l\'État'],
            ['src' => 'images/centre_accueil_etat_2022/dons-vivres.png', 'alt' => 'Dons et vivres préparés pour la distribution (eau, riz, pâtes, boissons)'],
            ['src' => 'images/centre_accueil_etat_2022/distribution-aide.png', 'alt' => 'Distribution d\'aide humanitaire (eau, nourriture, hygiène, Colgate)']
        ]
    ],
    [
        'annee' => '2023',
        'date' => '15 novembre 2023',
        'titre' => 'Soutien à l’Hôpital Mabanga',
        'lieu' => 'Yolo, Kinshasa',
        'description' => 'Soutien médical et donations à l\'Hôpital Mabanga de Yolo. La Fondation TMK s\'est engagée à fournir des équipements médicaux et des produits de première nécessité pour améliorer les conditions de soins des patients et soutenir le personnel soignant.',
        'image' => 'images/hopital_mabanga_yolo_2023/1.jpg',
        'images' => [
            ['src' => 'images/hopital_mabanga_yolo_2023/1.jpg', 'alt' => 'Donations à l\'Hôpital Mabanga'],
            ['src' => 'images/hopital_mabanga_yolo_2023/4.jpg', 'alt' => 'Visite des patients'],
            ['src' => 'images/hopital_mabanga_yolo_2023/5.jpg', 'alt' => 'Remise des dons'],
            ['src' => 'images/hopital_mabanga_yolo_2023/6.jpg', 'alt' => 'Équipe TMK à l\'hôpital']
        ]
    ],
    [
        'annee' => '2024',
        'date' => '10 janvier 2024',
        'titre' => 'Appui au Complexe Scolaire Elohim',
        'lieu' => 'Kinshasa',
        'description' => 'Distribution de kits scolaires et soutien aux infrastructures pour garantir un environnement d\'apprentissage propice aux élèves, soulignant l\'importance de l\'éducation comme pilier du développement.',
        'image' => 'images/complexe_scolaire_elohim_2024/1.jpg',
        'images' => [
            ['src' => 'images/complexe_scolaire_elohim_2024/1.jpg', 'alt' => 'Remise de kits scolaires'],
            ['src' => 'images/complexe_scolaire_elohim_2024/3.jpg', 'alt' => 'Élèves en classe'],
            ['src' => 'images/complexe_scolaire_elohim_2024/4.jpg', 'alt' => 'Distribution de fournitures'],
            ['src' => 'images/complexe_scolaire_elohim_2024/5.jpg', 'alt' => 'Photo de groupe avec les élèves']
        ]
    ],
    [
        'annee' => '2024',
        'date' => '10 mars 2024',
        'titre' => 'Descente à l’orphelinat MMMP',
        'lieu' => 'Nsele, Mikonga II (avenue MAKILA n°7)',
        'description' => 'En partenariat avec la Fondation BOMOKO PO TOSUNGANA (BPT). Actions : paiement des professeurs pour maintenir la motivation, fournitures scolaires pour la scolarité, et nourriture pour une bonne nutrition sur plusieurs mois. Orphelinat géré par Sœur Bernadette.',
        'image' => 'images/orphelinat_marie_2024/1.jpg',
        'images' => [
            ['src' => 'images/orphelinat_marie_2024/1.jpg', 'alt' => 'Orphelinat MMMP'],
            ['src' => 'images/orphelinat_marie_2024/2.jpg', 'alt' => 'Enfants de l\'orphelinat'],
            ['src' => 'images/orphelinat_marie_2024/3.jpg', 'alt' => 'Distribution de repas'],
            ['src' => 'images/orphelinat_marie_2024/4.jpg', 'alt' => 'Activités avec les enfants']
        ]
    ]
];
?>
...
<style>
/* ===== Section Aide humanitaire – style unifié ===== */
.section-realisations {
	background: linear-gradient(180deg, #f8fafc 0%, #f1f5f9 50%, #fff 100%);
	padding-top: 2.5rem;
	padding-bottom: 3rem;
}
.realisations-content-box { max-width: 960px; margin: 0 auto; }
.realisations-lead {
	font-size: 1.12rem;
	line-height: 1.8;
	color: #475569;
...
.timeline-item { position: relative; margin-bottom: 3rem; padding-left: 0; }
...
.timeline-card { width: calc(50% - 32px); margin-top: 32px; position: relative; }
.timeline-left .timeline-card { margin-left: 0; margin-right: auto; padding-right: 44px; }
.timeline-right .timeline-card { margin-left: auto; margin-right: 0; padding-left: 44px; }
.timeline-card-inner {
	background: #fff;
	border-radius: 16px;
	overflow: hidden;
...
.timeline-card-image > img { width: 100%; height: 100%; object-fit: cover; display: block; }
.timeline-gallery {
	display: grid;
...
.timeline-gallery-item:hover img { transform: scale(1.08); }
.timeline-gallery-item:focus { outline: 2px solid #1e40af; outline-offset: 2px; }
...
.timeline-gallery-item:focus .timeline-gallery-zoom { opacity: 1; }
.timeline-gallery img { height: 100%; min-height: 96px; }
@media (min-width: 768px) {
	.timeline-gallery { grid-template-columns: repeat(3, 1fr); gap: 10px; }
	.timeline-card-image { height: 220px; }
	.timeline-gallery { min-height: 220px; }
}
...
.timeline-card-content { padding: 1.4rem 1.5rem 1.6rem; }
.timeline-meta {
	font-size: 0.8rem;
	color: #64748b;
...
.realisations-back-wrap { margin-top: 2.5rem; margin-bottom: 0; text-align: center; }
...
.realisations-back-link i { font-size: 0.85em; }
.timeline-lightbox {
	display: flex;
	position: fixed;
	inset: 0;
...
.timeline-lightbox.active { opacity: 1; visibility: visible; pointer-events: auto; }
...
.timeline-lightbox-title { font-size: 1rem; font-weight: 600; letter-spacing: 0.04em; }
...
@media (max-width: 768px) {
	.section-realisations { padding-top: 1.5rem; padding-bottom: 2rem; }
	.realisations-lead { margin-bottom: 1.75rem; font-size: 1.05rem; line-height: 1.75; padding: 0 0.5rem; }
	.realisations-title { font-size: 1.4rem; letter-spacing: 0.05em; margin-bottom: 1.75rem; }
	.realisations-timeline::before { left: 20px; width: 2px; }
	.timeline-date-badge { left: 20px; transform: none; padding: 6px 14px; font-size: 0.85rem; }
	.timeline-card {
		width: 100%;
	...
	.timeline-card-inner:hover { transform: none; }
	.timeline-card-image { height: 180px; }
	.timeline-gallery { min-height: 180px; gap: 6px; }
	.timeline-card-content { padding: 1.15rem 1.25rem 1.35rem; }
	.timeline-card-title { font-size: 1.1rem; line-height: 1.35; }
	.timeline-card-desc { font-size: 0.92rem; line-height: 1.7; }
	.realisations-back-wrap { margin-top: 2rem; }
	.realisations-back-link { font-size: 0.9rem; padding: 0.6rem 1.1rem; }
}
</style>
