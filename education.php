...
$pageTitle = 'Éducation pour tous';
$content = 'Programmes éducatifs innovantes pour les enfants et jeunes des communautés défavorisées, avec un focus sur l\'alphabétisation.';

// Données structurées : réalisations éducation (même format que projets humanitaires)
$realisations = [
    [
        'annee' => '2024',
        'date' => 'Année scolaire 2024-2025',
        'titre' => 'Descente au complexe scolaire ELOHIM',
        'lieu' => 'Kintambo, quartier Lubudi de Camp Luka, avenue 31. Mosamba n°1',
        'description' => "Nul ne peut ignorer que l'éducation est l'ensemble des processus visant à transmettre des connaissances, des valeurs, des compétences et des comportements. Elle permet également à un individu de se développer intellectuellement, moralement, socialement et physiquement, afin de s'intégrer dans la société et de contribuer à son évolution.\n\nConscient de cela, la fondation avait décidé de soutenir cette lutte du droit à l'éducation aux enfants en apportant aux jeunes élèves de ladite école qui se trouve dans la commune de KINTAMBO, dans le quartier LUBUDI DE CAMP LUKA, sur l'avenue 31. MOSAMBA N°1 les fournitures scolaires pour leur permettre à bien étudier et avoir les éléments nécessaires pour bien débuter l'année allant de 2024-2025.",
        'image' => 'images/education_elohim_2024/Ecole1.png',
        'images' => [
            ['src' => 'images/education_elohim_2024/Ecole1.png', 'alt' => 'Vue du complexe scolaire C.S. ELOHIM – Fondation Maboko Mpete, Camp Luka'],
            ['src' => 'images/education_elohim_2024/Ecole2.png', 'alt' => 'Classe d\'élèves au complexe scolaire ELOHIM'],
            ['src' => 'images/education_elohim_2024/Ecole3.png', 'alt' => 'Équipe et bénévoles au complexe scolaire ELOHIM'],
            ['src' => 'images/education_elohim_2024/Ecole4.png', 'alt' => 'Distribution de sacs à dos aux élèves – C.S. ELOHIM'],
            ['src' => 'images/education_elohim_2024/Ecole5.png', 'alt' => 'Distribution de cahiers et fournitures aux élèves – C.S. ELOHIM'],
            ['src' => 'images/education_elohim_2024/Ecole6.png', 'alt' => 'Remise de tenues et fournitures aux élèves – C.S. ELOHIM'],
            ['src' => 'images/education_elohim_2024/Ecole7.png', 'alt' => 'Élèves avec leurs fournitures scolaires – C.S. ELOHIM']
        ]
    ]
];
?>
...
<style>
/* ===== Section Éducation – style unifié (aligné projets humanitaires) ===== */
