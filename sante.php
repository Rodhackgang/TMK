...
$pageTitle = 'Services de Santé';
$content = 'Accès aux soins primaires et campagnes de prévention dans les zones reculées pour améliorer la santé communautaire.';
...
$realisations = [
    [
        'annee' => '2023',
        'date' => 'Année 2023',
        'titre' => 'Descente à l\'hôpital Mabanga & lutte contre la drépanocytose',
        'lieu' => 'Kinshasa (Yolo – Hôpital Mabanga)',
        'description' => "Étant une année jugée décisive, THE MIRACLE KINGDOM avait décidé d'améliorer et de diversifier ses activités. Descente vers les personnes démunies : pour 2023, TMK avait prévu d'aller aussi dans les endroits où les gens se trouvent dans des circonstances impasses, tels que les hôpitaux.\n\nLa drépanocytose est un groupe de maladies héréditaires : les globules rouges sont déformés (en faucilles), meurent précocement et peuvent bloquer la circulation sanguine. La fondation a décidé d'apporter son soutien à l'hôpital MABANGA (YOLO MEDICAL), spécialisé pour les personnes drépanocytaires.\n\nNécessités identifiées : sachets de sang ; médicaments élémentaires (ACIDE FOLIQUE, HYDREA, PENVIC, AMOXYCILINE, LYNEVITE, LYCOTON, TRAMADOL, ACCUPAN, COMPRESSES STÉRILES, SPASFON, NIFLURI, PROFENID, ORNID, AMYCEF, SERENES, IPPROSEC, BETADINE, PRITHER, ACUPAN, ARAUPHAR, WATT…). TMK soutient les personnes drépanocytaires en apportant ces nécessités et le paiement des facturations des malades (en fonction des moyens disponibles).\n\nLutte pour réduire les taux de drépanocytose : la maladie est héréditaire. La fondation veut organiser des tests gratuits d'électrophorèse pour les couples et une campagne à grande échelle de sensibilisation sur les dangers de la drépanocytose.",
        'image' => 'images/sante/drepanocytose-symptomes.png',
        'images' => [
            ['src' => 'images/sante/drepanocytose-symptomes.png', 'alt' => 'Symptômes de la drépanocytose – anémie, crises douloureuses, infections'],
            ['src' => 'images/sante/drepanocytose-globules-sains-malades.png', 'alt' => 'Globules sains vs globules falciformes – circulation sanguine'],
            ['src' => 'images/sante/drepanocytose-rfi.png', 'alt' => 'La drépanocytose – maladie génétique la plus répandue (RFI)'],
            ['src' => 'images/sante/tmk-chargement-vehicule.png', 'alt' => 'Chargement des fournitures – en route vers l\'hôpital Mabanga'],
            ['src' => 'images/sante/perfusion-sang-hopital.png', 'alt' => 'Perfusions et sachets de sang à l\'hôpital'],
            ['src' => 'images/sante/remise-medicaments-patient.png', 'alt' => 'Remise des médicaments aux patients'],
            ['src' => 'images/sante/remise-document-hopital.png', 'alt' => 'Remise de documents ou soutien aux facturations'],
            ['src' => 'images/sante/tmk-equipe-sante.png', 'alt' => 'Équipe TMK Foundation sur le terrain – actions santé'],
            ['src' => 'images/sante/drepanocytose-transmission.png', 'alt' => 'Comprendre la transmission de la drépanocytose (RFI)']
        ]
    ]
];
?>
...
<style>
/* ===== Section Santé – style unifié (aligné projets humanitaires) ===== */
